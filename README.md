...
#Ingles
This project involves the design and implementation of an IP-based paging and intercom system for educational institutions using VoIP (Voice over IP) technology. The solution utilizes a Speedytel IPPBX 220 router as the central private branch exchange (PBX) and Raspberry Pi-based receiving nodes in each classroom.
